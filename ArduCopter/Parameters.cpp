...
const AP_Param::Info Copter::var_info[] = {
    // @Param: ROLL_P
    // @DisplayName: Proportional-roll
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(roll_p, "ROLL_P", ROLL_P_DEFAULT),

    // @Param: ROLL_I
    // @DisplayName: Integral-roll
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(roll_i, "ROLL_I", ROLL_I_DEFAULT),

    // @Param: ROLL_D
    // @DisplayName: Derivative-roll
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(roll_d, "ROLL_D", ROLL_D_DEFAULT),

    // @Param: PITCH_P
    // @DisplayName: Proportional-pitch
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(pitch_p, "PITCH_P", PITCH_P_DEFAULT),

    // @Param: PITCH_I
    // @DisplayName: Integral-pitch
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(pitch_i, "PITCH_I", PITCH_I_DEFAULT),

    // @Param: PITCH_D
    // @DisplayName: Derivarive-pitch
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(pitch_d, "PITCH_D", PITCH_D_DEFAULT),

    // @Param: YAW_P
    // @DisplayName: Proportional-yaw
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(yaw_p, "YAW_P", YAW_P_DEFAULT),

    // @Param: YAW_I
    // @DisplayName: Integral-yaw
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(yaw_i, "YAW_I", YAW_I_DEFAULT),

    // @Param: YAW_D
    // @DisplayName: Derivative-yaw
    // @Description: No comment
    // @Range: -32768 32767
    // @User: Advanced
    GSCALAR(yaw_d, "YAW_D", YAW_D_DEFAULT),

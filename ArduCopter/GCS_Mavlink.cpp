...
void GCS_MAVLINK_Copter::send_rakip_iha_konum()
{
       //mavlink_message_t msg;
     /*float boylam1 = boylam2;
     float enlem1 = enlem2;
     float irtifa1 = irtifa2;
    */
//mavlink_msg_rakip_iha_konum_decode(&msg, &packet1);
      mavlink_msg_rakip_iha_konum_send(
        chan,
        enlem1,
        boylam1,
        irtifa1);
...
void GCS_MAVLINK_Copter::send_kilitlenme(){

 mavlink_msg_kilitlenme_send(
	chan,
        merkez_x1,
        merkez_y1,
        merkez_z1,
...
void GCS_MAVLINK_Copter::send_sunucu_zamani(){

 mavlink_msg_sunucu_zamani_send(
	chan,
        saat1,
        dakika1,
	saniye1,
...
void GCS_MAVLINK_Copter::handleMessage(const mavlink_message_t &msg)
{
    ...
    case MAVLINK_MSG_ID_KILITLENME:
        mavlink_kilitlenme_t ramo;
        mavlink_msg_kilitlenme_decode(&msg, &ramo);
	merkez_x1 = ramo.merkez_x;
        merkez_y1 = ramo.merkez_y;
        merkez_z1 = ramo.merkez_z;
        genislik1=ramo.genislik;
	yukseklik1=ramo.yukseklik;
        break;

    case MAVLINK_MSG_ID_SUNUCU_ZAMANI:
        mavlink_sunucu_zamani_t ramco;
        mavlink_msg_sunucu_zamani_decode(&msg, &ramco);
	saat1 = ramco.saat;
        dakika1 = ramco.dakika;
        saniye1 = ramco.saniye;
        m_saniye1 = ramco.m_saniye;
        break;
    ...
    case MAVLINK_MSG_ID_RAKIP_IHA_KONUM:
        mavlink_rakip_iha_konum_t packet;
        mavlink_msg_rakip_iha_konum_decode(&msg, &packet);
        enlem1 =packet.enlem;
        boylam1 = packet.boylam;
        irtifa1 = packet.irtifa;
        break;
